...
load(strcat(maindir,'\eye_specs.mat'));
load(strcat(maindir,'\Y_simulated.mat'));
load(strcat(maindir,'\InducedCovariances.mat'));
load(strcat(maindir,'\DCompressed.mat'));

load(strcat(maindir,'\eye_filtered_wave_fmm\eye_filtered_wave_fmm.mat'),'model');
load(strcat(maindir,'\fhat_summary_all.mat'),'fhat_linear','fhat');
load(strcat(maindir,'\fdhat_summary_all.mat'),'fdhat_linear','fdhat');
load(strcat(maindir,'\df_mean.mat'));
load(strcat(maindir,'\fhat_circum_mean.mat'));
load(strcat(maindir,'\fhat_summary_all_region_section.mat'));
load(strcat(maindir,'\fdhat_summary_all_region_section.mat'));
load(strcat(maindir,'\region_section_results.mat'));
